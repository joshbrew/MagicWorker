    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/brainsatplay/MagicWorker',
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/brainsatplay/MagicWorker',
            // label: 'GitHub',
            position: 'right',
            ...
            items: [
              {
                ...
                href: 'https://stackoverflow.com/questions/tagged/web-workers',
              },
              {
                label: 'Discord',
